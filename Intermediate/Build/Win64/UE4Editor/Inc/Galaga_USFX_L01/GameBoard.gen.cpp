...
#include "Galaga_USFX_L01/GameBoard.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	GALAGA_USFX_L01_API UClass* Z_Construct_UClass_AGameBoard_NoRegister();
	GALAGA_USFX_L01_API UClass* Z_Construct_UClass_AGameBoard();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AGameBoard_Statics::Class_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "GameBoard.h" },
	};
#endif
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AGameBoard_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(Z_Construct_UClass_AGameBoard_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_AGameBoard_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(AGameBoard, 2764602239);
	template<> GALAGA_USFX_L01_API UClass* StaticClass<AGameBoard>()
	{
		return AGameBoard::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AGameBoard(Z_Construct_UClass_AGameBoard, &AGameBoard::StaticClass, TEXT("/Script/Galaga_USFX_L01"), TEXT("AGameBoard"), false, nullptr, nullptr, nullptr);
